...
def model(params, wl, freqProj, Cps):
    ...
    # Model
    cf_model = trans_ratio * Cps + Css * np.exp(2j * np.pi * freqProj)
...
if __name__ == '__main__':
    ...
    Cps_file = './templates/contrast_template_bt-settl_startpl.fits'
    #Cps_file = 'flat 7e-4'
    ...
    stellar_residuals_poly_coeffs_init = (1.32557020e-05,  2.61251921e-05, -6.78750772e-05,  1.76543933e-05)
