...
bbasedir = os.path.expanduser('~/SynologyDrive/driveFlorentin/DATA/GPAO_HR8799e/')
basedir  = bbasedir+'HR8799e_rawdata/'


outdir = os.path.expandvars('$HOME/HR8799e_MACAO/')
