...
bbasedir = os.path.expanduser('/Users/jscigliuto/Nextcloud/DATA/')
#bbasedir = os.path.expanduser('E:\SynologyDrive\dataExt4Tb/')
### MACAO data
basedir  = bbasedir+'HD72946B/raw_data_without_rmnfiles/'
#basedir  = bbasedir+'2023-02-03/'
### GPAO data
#basedir  = bbasedir+'2024-11-17_MATISSE_betaPic_b/'

outdir    = os.path.expanduser('/Users/jscigliuto/Nextcloud/DATA/HD72946B/Result_OPTRA')
